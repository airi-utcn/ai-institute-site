...
export default function Client({ aboutData }) {
  const title = aboutData?.proceduresTitle || "Regulations";
  const content = aboutData?.proceduresLead || "Content coming soon.";

  return (
    <main className="flex flex-col items-center justify-center bg-gray-50 dark:bg-gray-900 py-12">
      <div className="container max-w-6xl mx-auto bg-white dark:bg-gray-950 rounded-2xl shadow-xl p-6 md:p-8 animate-fade-in">
