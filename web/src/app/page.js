    ...
    <div>
      ...
      <section className="page-container pb-16">
        <div className="grid-cards">
          ...
          >
            ...
            <h3 className="heading-3 heading-accent mb-2">{t("Cards.research.title")}</h3>
            <p className="text-muted">
              {t("Cards.research.description")}
            </p>
          </Link>
          ...
          >
            ...
            <h3 className="heading-3 heading-accent mb-2">{t("Cards.people.title")}</h3>
            <p className="text-muted">
              {t("Cards.people.description")}
            </p>
          </Link>
          ...
          >
            ...
            <h3 className="heading-3 heading-accent mb-2">{t("Cards.resources.title")}</h3>
            <p className="text-muted">
      ...
      <section className="page-container pb-16">
        <div className="flex items-center justify-between mb-8">
          <h2 className="heading-2 heading-accent">{t("LatestNews.title")}</h2>
          <Link
        ...
        {latestNews.length > 0 ? (
          ...
          <div className="card p-8 text-center">
            <p className="text-muted">{t("LatestNews.emptyState")}</p>
            <Link href="/news&events/news" className="link-accent mt-2 inline-block">
              {t("LatestNews.visitNews")}
            </Link>
          </div>
        )}
      </section>
